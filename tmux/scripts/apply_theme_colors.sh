...
fmt=""
fmt+="#{?window_zoomed_flag,#{?#{pane_mode},,#[fg=${THEME_YELLOW}] #[default]},}"
...
wc+=" #I ${SEP_RIGHT_THIN} #{?window_zoomed_flag,#{?#{pane_mode},, },}#W "
...
wf+=" #I ${SEP_RIGHT_THIN} #{?window_zoomed_flag,#{?#{pane_mode},, },}#W "
